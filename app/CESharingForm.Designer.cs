...
namespace SyncApplication
{
    partial class CESharingForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label4.Text = "Firebird to Sql CE Data Synchronization";
			// 
			// peerTabsControl
			// 
			...
			this.serverTab.Padding = new System.Windows.Forms.Padding(8);
			...
			this.TablesViewCtrl.Location = new System.Drawing.Point(8, 8);
			this.TablesViewCtrl.Name = "TablesViewCtrl";
			this.TablesViewCtrl.Size = new System.Drawing.Size(703, 293);
			...
			this.Text = "Share\'em - Firebird to Sql CE Data Synchronization Demo Application";
